...
export const signup = async (req: Request, res: Response) => {
  ...
  try {
    ...
    // Note: Using "Users" in quotes if your table was created with uppercase
    ...
    // 3. Insert user 
    // IMPORTANT: Ensure your column name is 'password' or 'password_hash' in PGAdmin
    ...
    console.error(" SIGNUP ERROR:", err.message); // This prints to your VS Code Terminal
    res.status(500).json({ 
